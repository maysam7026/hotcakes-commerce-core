...
<dnn:DnnJsInclude runat="server" FilePath="slider/slider-all.js" PathNameAlias="SkinPath" />
  ...
  <header class="header">
    <div class="container">
      <div class="row">
	    ...
	    <div class="col-sm-6 HeaderPane" id="HeaderPane" runat="server" visible="false"></div>
      </div>
    </div>
  </header>
 <!-- Navbar -->
  <div class="stickup">
    <div class="container nav-row clearfix">
      <div class="row">        
        <div class="dnn-logo"><dnn:LOGO runat="server" id="dnnLOGO" BorderWidth="0" /><div class="LogoPane" id="LogoPane" runat="server" visible="false"></div></div>
  ...
  <div class="mycontent">
  <div class="container">
    <div class="TopServicePane" id="TopServicePane" runat="server" visible="false"></div>
  </div>
  <div class="GalleryPaneBg">
    <div class="container">
      <div class="GalleryPane" id="GalleryPane" runat="server" visible="false"></div>
    </div>
  </div>
    <div class="container">
      <div class="row">
	...
	<div class="full-width-bg">
	  ...
	  <div class="container">
	    <div class="row">
	      <div class="col-sm-12 FullWidthPane" id="FullWidthPane" runat="server" visible="false"></div>
        </div>
      </div>
    </div>
	<div class="container">
